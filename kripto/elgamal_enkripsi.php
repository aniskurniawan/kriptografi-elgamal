...
<div id="Enkripsi" class="tabcontent">
    ...
    <?php if (isset($_POST['enkripsi'])){
        echo '
            ...
            p = '.$p.'</span>, <span style="color:blue;"> g = '.$g.',</span> dan <span style="color:blue;">x = '.$x.'</span> :</b></p>
            <p>
            1. Nilai k secara acak (1 = k = p - 1) = <b>'.$k.'</b><br/>
            2. Kunci Publik (y, g, p) = (<b>'.$y.'</b>, <b>'.$g.'</b>, <b>'.$p.'</b>)<br/>
            3. Kunci Privat (x, p) = (<b>'.$x.'</b>, <b>'.$p.'</b>)
